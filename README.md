...
- 📦 **Большая коллекция** — 530 логотипов SVG/PNG и 1918 эмодзи Apple, Google, Microsoft
...
├── blog/                  # Блог
├── tools/figma-plugins/   # Figma плагины (Trace Logo's, Trace Typograf, Photo Editor)
