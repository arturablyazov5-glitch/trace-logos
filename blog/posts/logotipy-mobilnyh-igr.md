---
title: Логотипы мобильных игр — почему у всех объёмные буквы
...
Стиль, ставший стандартом жанра, отточила Supercell: [Clash of Clans](../../logos/game/clashofclans/), [Clash Royale](../../logos/game/clashroyale/), [Brawl Stars](../../logos/game/brawlstars/), [Hay Day](../../logos/game/hayday/) — везде одна формула: мясистые 3D‑буквы с тёмной обводкой, золотыми или цветными гранями и лёгким наклоном. Почему это работает:
...
| Правило брендинга | Игровая категория |
| --- | --- |
| Упрощай ([почему](../pochemu-brendy-uproshchayut-logotipy/)) | детализируй: фактура продаёт |
| Монохромная версия обязательна | почти не нужна: знак живёт только на экране |
| Вне трендов, на десятилетия | живёт 3‑5 лет вместе с игрой |
...
## The logo as packaging

The category's key: a player decides to install within seconds, scrolling past thousands of competitors. A game logo plays the role of product packaging — like a cereal box on a shelf: not "expressing brand values" but shouting "fun/epic/scary here" louder than the neighbors. Game marks are judged by poster laws, not the identity laws that shape [app icons](../ikonka-prilozheniya/).

## The Supercell canon: chunky outlined letters

The style that became the genre standard was honed by Supercell: [Clash of Clans](../../logos/game/clashofclans/), [Clash Royale](../../logos/game/clashroyale/), [Brawl Stars](../../logos/game/brawlstars/), [Hay Day](../../logos/game/hayday/) — one formula throughout: meaty 3D letters with dark outlines, gold or colored bevels and a slight tilt. Why it works:

- **The outline** separates the mark from any background — a battle screenshot, a banner, a video.
- **Volume and gold** signal "a rich world, premium production" — texture carries meaning here.
- **The tilt and bouncing letters** convey motion: a static sober typeface would read as office software — a clear case of [how type sets character](../shrift-dlya-logotipa/).

## A character instead of a mark

The category's second pillar is [mascots](../chto-takoe-maskot/). The [Angry Birds 2](../../logos/game/angrybirds2/) icon houses the red bird; [Among Us](../../logos/game/amongus/) has its astronaut — a planet-scale meme. A character does what letters can't: it can be loved. It lives in stickers, merch and memes, advertising the game for free — the same logic behind [branded stickers on Telegram](../kak-sdelat-svoi-emodzi-v-telegram/).

## Genshin Impact: the Asian school's exception

[Genshin Impact](../../logos/game/genshinimpact/) shows another tradition: elegant thin-serif typography with no shouting volume. Asian RPGs sell not "fun bubblegum" but "a grand beautiful adventure" — their logos sit closer to film posters than arcades. A useful reminder: the category canon is not law but a reflection of genre. A casual game styled like Genshin would lose installs; an RPG styled like Brawl Stars would lose credibility.

## Icon vs logo: the game mark's double life

A game's mark lives two parallel lives ruled by different laws. **The logo** (the name on the splash screen and store page) is a poster: chunky letters, textures, full composition. **The icon** is the shelf front in the store grid, where something else wins: a character's face shot large, maximum contrast, minimal text. Look at [Brawl Stars](../../logos/game/brawlstars/) or [Clash Royale](../../logos/game/clashroyale/): the icon contains not a single letter of the name — only a close-up character. Studios A/B-test icons like ad creatives and swap them for seasonal events while the logo stays stable. The role split is taken to the limit: the icon sells the tap, the logo accrues recognition — the same split we cover in [how app icons work](../ikonka-prilozheniya/).

## How game marks differ from "normal" ones

| Branding rule | The game category |
| --- | --- |
| Simplify ([why](../pochemu-brendy-uproshchayut-logotipy/)) | detail up: texture sells |
| Monochrome version required | barely needed: the mark lives on screens only |
| Timeless, for decades | lives 3-5 years with the game |
| Mark separate from product | the mark IS a screenshot of the game's style |
| Strict grid and geometry | bouncing letters and tilt |
