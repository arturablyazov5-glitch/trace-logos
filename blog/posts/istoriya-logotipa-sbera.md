---
title: История логотипа Сбербанка — от копилки 1841 года до градиентного круга
title_en: The History of the Sberbank Logo — From 1841 to the Gradient Circle
description: Как менялся логотип Сбербанка: советская эмблема, зелёная галочка 1991 года, объёмный знак 2009‑го и радикальный ребрендинг «Сбер» 2020 года. С разбором логики каждого шага.
description_en: How the Sberbank logo evolved — the Soviet emblem, the 1991 green check, the glossy 2009 mark and the radical 2020 Sber rebrand, with the logic of each step.
date: 2026-06-13
slug: istoriya-logotipa-sbera
tags: Сбер, История, Ребрендинг
...
Если сжать всё сказанное в текст, видна та же закономерность: каждая строка отмечает смену среды, а вкусы тут ни при чём.

| Период | Знак | Что изменилось вокруг |
| --- | --- | --- |
| до 1991 | вывески, гербы, атрибуты бережливости | госмонополия, отличаться не от кого |
...
Из четырёх эпох выводятся четыре урока, полезных для любого редизайна:

1. **Форма живёт дольше стиля.** Галочка в круге пережила три оформления и тридцать с лишним лет, потому что сама форма проста и осмысленна. Вкладываться стоит в силуэт: спецэффекты устареют с ближайшей модой.
2. **Ребрендинг отвечает на смену среды.** 2009‑й отвечал моде на глянец, 2020‑й — переезду бренда в смартфон. Меняться без причины дорого; не меняться, когда среда уже сменилась, — ещё дороже.
3. **Эволюция бьёт революцию.** Даже радикальный 2020‑й сохранил ядро: круг, галочку, зелёный. Узнаваемость — накопленный актив, и его не сжигают ради новизны.
4. **Цвет — константа.** Зелёный [Сбера](../../logos/bank/sber/) пережил все эпохи, менялся только оттенок (текущий — #21A038). Точный код цвета — часть бренда наравне со знаком, о чём писали в статье [про фирменные цвета](../firmennye-cveta-izvestnyh-brendov/).

## Если коротко

Галочка [Сбера](../../logos/bank/sber/) — редкий пример знака‑долгожителя: рождённый в 1991‑м, он пережил глянец нулевых и минимализм двадцатых, потеряв объём, но сохранив форму и цвет. И вся его история подчинена одной логике — знак менялся ровно тогда и ровно настолько, насколько менялась среда вокруг: рынок, мода, экран. Это готовая шкала, по которой можно калибровать любой редизайн: оформление меняют по эпохе, ядро — почти никогда.

Сравнить все версии своими глазами можно в нашем каталоге: на странице [логотипа Сбера](../../logos/bank/sber/) собраны и актуальный знак, и исторические варианты — от эмблемы 1991 года до градиентного круга, все в векторе.
...
1. **Shape lives longer than style.** The check in a circle outlived three finishes and thirty-plus years because the shape itself is simple and meaningful. Invest in the silhouette: effects will date with the next fashion.
2. **A rebrand answers a change of environment.** 2009 answered the fashion for gloss, 2020 the brand's move into the smartphone. Changing without reason is expensive; not changing once the environment has shifted is more expensive still.
3. **Evolution beats revolution.** Even the radical 2020 kept the core: circle, check, green. Recognition is an accumulated asset, and you don't burn it for novelty.
4. **Color is a constant.** [Sber](../../logos/bank/sber/) green survived every era, only the shade changing (currently #21A038). An exact color code is part of the brand on par with the mark, as covered in the article [on brand colors](../firmennye-cveta-izvestnyh-brendov/).

## In short

The [Sber](../../logos/bank/sber/) check is a rare example of a long-lived mark: born in 1991, it survived the gloss of the 2000s and the minimalism of the 2020s, losing volume but keeping shape and color. And its whole history obeys one logic — the mark changed exactly when, and exactly as much as, the environment around it changed: market, fashion, screen. It's a ready scale for calibrating any redesign: change the finish by the era, the core almost never.

You can compare all versions with your own eyes in our catalog: the [Sber logo page](../../logos/bank/sber/) gathers both the current mark and historical variants — from the 1991 emblem to the gradient circle, all in vector.
