---
title: Как сделать логотип самому бесплатно — честная пошаговая инструкция
title_en: How to Make a Logo Yourself for Free — An Honest Step-by-Step Guide
description: Пошагово делаем логотип без дизайнера: идея, знак, шрифт, цвет, файлы. Бесплатные инструменты (Figma, Inkscape), типичные ошибки новичков и когда лучше заплатить.
description_en: Making a logo without a designer, step by step — idea, mark, type, color, files. Free tools (Figma, Inkscape), rookie mistakes and when to pay instead.
date: 2026-06-19
slug: kak-sdelat-logotip-samomu
...
До открытия редактора ответьте письменно: что делает компания, для кого, и какое одно ощущение должен оставлять знак (надёжность? скорость? забота? дерзость?). Одно, не пять. Каждое решение дальше — форма, цвет, шрифт — сверяйте с этим предложением. Это и есть та работа, за которую платят студиям: у вас она займёт полчаса и сэкономит десять кругов переделок.
...
Для самостоятельной работы реалистичны три:

- **Текстовый (wordmark):** название аккуратным шрифтом, возможно с одной модификацией (срезанная буква, лигатура, точка цвета). Самый безопасный путь — сложно испортить.
- **Монограмма:** 1‑2 буквы в простой форме (круг, квадрат, щит). Хорош, когда название длинное.
- **Простой знак + текст:** геометрический символ рядом с названием. Рискованнее: нужен «тот самый» символ.

Маскоты, сложные иллюстрации, градиентные 3D‑эмблемы — не ваш уровень сложности сегодня. И, как мы разбирали в статье [про упрощение логотипов](../pochemu-brendy-uproshchayut-logotipy/), даже гиганты ушли от сложности — она больше не признак статуса.

## Шаг 4. Эскизы на бумаге (важно: до компьютера)

10‑20 быстрых карандашных набросков по 30 секунд. На бумаге варианты генерируются в разы быстрее, и рука не цепляется за возможности редактора. Отберите 2‑3 живых направления.
...
- **Тест 16 пикселей:** уменьшите логотип до размера фавикона. Узнаётся? Текст мельче знака имеет право пропасть, но знак должен выжить.
...
## Разбор на сквозном примере: логотип кофейни «Восход»

Пройдём процесс на конкретном кейсе, чтобы шаги перестали быть абстракцией.

**Шаг 1, смысл:** «Утренняя кофейня у офисного квартала; одно ощущение — бодрое тёплое начало дня».

**Шаг 2, насмотренность:** полчаса в каталоге по категории «еда/кофе» — видим паттерны: зерно, чашка, пар; тёплые коричневые и терракота; много леттеринга. Вывод: чашку и зерно не берём (заезжены), берём метафору восхода.

**Шаг 3, тип:** знак + текст: полукруг солнца, встающий из «блюдца»-линии, рядом название геометрическим гротеском.

**Шаги 4‑5, эскизы и отрисовка:** на бумаге выясняется, что солнце с лучами в 16 пикселях превращается в ежа — лучи убираем, оставляем чистый полукруг с одной дугой‑паром. В [Figma](../../logos/design/figma/): полукруг = круг минус прямоугольник (булева операция), дуга — сегмент окружности со скруглёнными концами. Цвет — терракота #C8552D (тёплый, свободный в категории по нашей карте), шрифт — Manrope SemiBold.

**Шаг 6, тесты:** в 16 px полукруг читается; в монохроме работает; на тёмном фоне заменяем терракоту на светлый беж. Поиск по картинке двойников не нашёл.
...
## Что делать после логотипа: минимальный запуск айдентики

Логотип готов — потратьте ещё один вечер, чтобы он заработал системно:
...
Смысл → насмотренность → бумажные эскизы → геометричная отрисовка в [Figma](../../logos/design/figma/) → тесты (16 px, монохром, фоны) → комплект файлов. Держитесь простоты: один шрифт, один цвет, ровная геометрия. Такой логотип не выиграет конкурс, но будет честно и аккуратно работать, пока бизнес не дорастёт до студийного.

Насмотренность — половина результата: полистайте решения вашей отрасли в нашем [каталоге логотипов](../../logos/) перед тем, как открыть [Figma](../../logos/design/figma/).

---EN---

No budget for a designer, generators churn out templates, and you need a logo. Good news: a decent starter logo is genuinely doable yourself, for free, in an evening or two — if you follow the right process instead of drawing "something pretty" at random. Bad news: DIY logos have typical failures that give them away at first glance. Let's walk the process so you avoid them.

:::note TL;DR
The starter-logo formula: **a simple mark or a clean wordmark + one color + one typeface**. Tools: [Figma](../../logos/design/figma/) (free) or Inkscape. Process: meaning → visual research → paper sketches → vector drawing → small-size test → file kit. Don't aim for "expensive and complex" — complexity is exactly what betrays a DIY job.
:::
...
Before opening any editor, write down: what the company does, for whom, and the one feeling the mark should leave (reliability? speed? care? boldness?). One, not five. Check every later decision — shape, color, type — against that sentence. This is the work studios charge for; yours takes half an hour and saves ten rounds of redoing.
...
Three are realistic solo:

- **Wordmark:** the name in a clean typeface, perhaps with one modification (a cut letter, a ligature, a colored dot). The safest path — hard to ruin.
- **Monogram:** 1–2 letters in a simple shape (circle, square, shield). Great for long names.
- **Simple mark + text:** a geometric symbol beside the name. Riskier: the symbol has to be *right*.

Mascots, complex illustrations, 3D gradient emblems — not today's difficulty level. As covered in [why brands simplify](../pochemu-brendy-uproshchayut-logotipy/), even giants fled complexity — it's no longer a status marker.

## Step 4. Paper sketches (before the computer!)

10–20 quick 30-second pencil sketches. Paper generates options far faster, and your hand doesn't cling to editor features. Keep 2–3 live directions.
...
- **The 16-pixel test:** shrink to favicon size. Recognizable? Small text may vanish, but the mark must survive.
...
## A worked example: the "Sunrise" coffee shop logo

Let's run the process on a concrete case so the steps stop being abstract.

**Step 1, meaning:** "A morning coffee shop by an office district; the one feeling — a warm, energizing start of the day."

**Step 2, research:** half an hour in the food/coffee category — the patterns emerge: beans, cups, steam; warm browns and terracotta; lots of lettering. Conclusion: skip the bean and the cup (worn out), take the sunrise metaphor.

**Step 3, type:** mark + text: a semicircle sun rising from a "saucer" line, the name beside it in a geometric sans.

**Steps 4–5, sketches and drawing:** paper reveals that a sun with rays becomes a hedgehog at 16 pixels — the rays go, leaving a clean semicircle with one steam arc. In [Figma](../../logos/design/figma/): the semicircle = circle minus rectangle (boolean), the arc — a circle segment with rounded caps. Color — terracotta #C8552D (warm, free in the category per our map), typeface — Manrope SemiBold.

**Step 6, tests:** the semicircle reads at 16 px; monochrome works; on dark, terracotta swaps to light beige. Reverse image search finds no twins.
...
## After the logo: the minimal identity launch

The logo is done — spend one more evening making it work as a system:
