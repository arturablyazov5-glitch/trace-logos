---
title: История логотипа Spotify — зелёный круг и три волны
title_en: The Spotify Logo History — The Green Circle and Three Waves
description: Как менялся логотип Spotify: от зелёного слова 2008 года до круга с волнами и скандала вокруг оттенка. Что означают три дуги и почему зелёный именно такой.
description_en: How the Spotify logo evolved: from the 2008 green wordmark to the wave circle and the shade controversy. What the three arcs mean.
date: 2026-07-31
slug: istoriya-logotipa-spotify
tags: Истории логотипов, Брендинг, Медиа
tags_en: Logo Histories, Branding, Media
---

Знак [Spotify](../../logos/media/spotify/) — зелёный круг с тремя дугами — сегодня опознаётся быстрее, чем логотипы большинства музыкальных лейблов, ради которых сервис когда‑то создавался. Разбираем его историю: откуда взялись «волны», зачем компания сменила спокойный зелёный на «кислотный» и почему интернет спорил об этом оттенке несколько недель.
...
The [Spotify](../../logos/media/spotify/) mark — a green circle with three arcs — is now recognized faster than the logos of most music labels the service was once built around. Here's its history: where the "waves" came from, why the company swapped its calm green for a "neon" one, and why the internet argued about that shade for weeks.
...
## What the three arcs mean

Officially — sound waves radiating from a source: the universal "sound here" symbol, tied to neither notes nor headphones. A practical choice: a note would have meant "music", and Spotify has long been wider — podcasts, audiobooks. The abstract waves survived the product's expansion without a redesign — exactly the trap that caught the word "Coffee" at [Starbucks](../istoriya-logotipa-starbucks/) and the "Tube" syllable at [YouTube](../istoriya-logotipa-youtube/), and that Spotify dodged.
...
Spotify owns a medium most brands lack — other people's content: "Listen on Spotify" buttons live on artist sites, in podcasts, on concert posters. For that scenario the company keeps a separate rulebook and ready-made badges: the mark can't be recolored to match a poster, the minimum size is fixed, clear space is mandatory. It's the standard problem of any platform brand: your mark will be placed by people without designers, so you need fool-proof prefab blocks — we cover [why brand books exist](../chto-takoe-brendbuk/) separately.
