const BASE_URL = 'https://app.lava.top/products/6f3c8efd-27c3-41a8-acb1-559b83ea3b46/d9261f0e-d716-418c-b91d-764e83f1c01c?currency=';
const LABELS = { ru: 'Поблагодарить автора', en: 'Support the author' };

class DonateBtn extends HTMLElement {
  connectedCallback() {
    ...
    this.innerHTML = `
      <a class="btn-donate" href="${BASE_URL}${currency}" target="_blank" rel="noopener noreferrer">
...
customElements.define('donate-btn', DonateBtn);
